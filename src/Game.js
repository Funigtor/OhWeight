       ...
       death: function(player , junkfood){
        junkfood.kill();
         ...
         if(this.speed <= 200){
           ...
           this.startButton = this.add.button(this.game.camera.x +250,this.game.camera.y + 400, 'button-start', this.retry, this, 2, 0, 1);
       		 this.startButton.anchor.set(0.5,0);
       		 this.startButton.input.useHandCursor = true;
           this.startButton = this.add.button(this.game.camera.x +550,this.game.camera.y + 400, 'button-start', this.returnMenu, this, 2, 0, 1);
       		 this.startButton.anchor.set(0.5,0);
       		 this.startButton.input.useHandCursor = true;
